...
public class ConnectProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 3; i++) {
                ...
                OrderInfo onOrder = new OrderInfo("10000", random.nextInt(500), System.currentTimeMillis());
                ...
                ProducerRecord<String, String> offTopic =
                        new ProducerRecord<>("off_topic", "key-" + i, offData);
                ProducerRecord<String, String> onTopic =
                        new ProducerRecord<>("on_topic", "key-" + i, onData);

...
public class SideOutputDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<MjSensorReading> sensorDS = env.fromElements(
                new MjSensorReading("devide1",33,System.currentTimeMillis()),
                new MjSensorReading("devide2",70,System.currentTimeMillis()),
                new MjSensorReading("devide3",70,System.currentTimeMillis())
        );

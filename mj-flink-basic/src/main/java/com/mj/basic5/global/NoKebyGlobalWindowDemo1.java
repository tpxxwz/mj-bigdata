 ...
 * @desc 版权所有，请勿外传
 */
public class NoKebyGlobalWindowDemo1 {
    public static void main(String[] args) throws Exception {
        ...
        Trigger<Object, GlobalWindow> countTrigger = CountTrigger.of(10);  // 每10条数据触发
        // 6. 定义窗口并处理窗口数据
        parsedStream.windowAll(GlobalWindows.create())
                .trigger(countTrigger)
                .process(new ProcessAllWindowFunction<WaterMarkData, String, GlobalWindow>() {

                    @Override
                    public void process(ProcessAllWindowFunction<WaterMarkData, String, GlobalWindow>.Context context, Iterable<WaterMarkData> elements, Collector<String> out) throws Exception {
                        // 获取窗口元数据（计数窗口无时间范围）

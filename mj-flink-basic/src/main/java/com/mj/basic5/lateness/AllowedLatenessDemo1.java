...
public class AllowedLatenessDemo1 {
    public static void main(String[] args) throws Exception {
        ...
        // 6. 定义窗口并处理窗口数据（添加 allowedLateness）
        keyedStream.window(TumblingEventTimeWindows.of(Duration.ofSeconds(10)))
                // 设置允许延迟时间为 5 秒
                .allowedLateness(Duration.ofSeconds(5))  // 或 Duration.ofSeconds(5)（取决于 Flink 版本）
                .process(new ProcessWindowFunction<WaterMarkData, String, String, TimeWindow>() {
                    ...
                    public void process(
                        ...
                        String output = String.format(
                                ...
                                context.currentWatermark() >= window.getEnd()  // 判断是否为延迟触发
                        );

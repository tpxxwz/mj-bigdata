 ...
 * @desc 版权所有，请勿外传
 */
public class ProcessProducerDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 5; i++) {
                // 同步发送
                WaterMarkData userWindow1 = new WaterMarkData("10000",System.currentTimeMillis(), random.nextInt(1000));
                WaterMarkData userWindow2 = new WaterMarkData("20000",System.currentTimeMillis(),random.nextInt(1000));

...
public class CheckpointProducerDemo1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 2; i++) {
                // 同步发送
                WaterMarkData userWindow1 = new WaterMarkData("10000",System.currentTimeMillis(), 100);
                WaterMarkData userWindow2 = new WaterMarkData("20000",System.currentTimeMillis(),100);

...
public class WindowReduceDemo {
    public static void main(String[] args) throws Exception {
        ...
        windowedStream.reduce(new ReduceFunction<UserWindow>() {
            @Override
            public UserWindow reduce(UserWindow currentObj, UserWindow newObj) throws Exception {
                UserWindow result = new UserWindow();
